...
//        [db executeUpdate:insertWantedSQL,aWanted.ID, aWanted.title, aWanted.content, aWanted.type, aWanted.rewardTime, aWanted.wantedManName, aWanted.wantedManGender, aWanted.wantedManAddress, aWanted.addTime, aWanted.updateTime];
        //NSString *sql = [NSString stringWithFormat:insertWantedSQL, aWanted.ID, aWanted.title, aWanted.content, aWanted.type, aWanted.rewardTime, aWanted.wantedManName, aWanted.wantedManGender, aWanted.wantedManAddress, aWanted.addTime, aWanted.updateTime];
        NSString *simpleSQL = [NSString stringWithFormat:insertWantedSimpleSQL, aWanted.ID, aWanted.title];
        success = [db executeUpdate:simpleSQL];
        [db close];
    }
