...
public class MomentServiceTest {
	...
	public void  tetstts(){
		...
		Page page1 = new Page();
		page1.setMediaUrl("www.sina.com");
	...
	public void tesdasd(){
		...
		System.out.print(momentService.query("select b from Moment a , Page b where a.idMOMENT=b.moment.idMOMENT"));
